...
export const User = observer(({id,first_name,last_name,email,avatar,isInvited}) => {
  ...
  return (
    <li>
      ...
      <img onClick={()=> usersStore.onClickInvite(id)} className="action" src={`/assets/${isInvited ? 'minus' : 'plus'}.svg`} alt="Action" />
    </li>
  );
});
